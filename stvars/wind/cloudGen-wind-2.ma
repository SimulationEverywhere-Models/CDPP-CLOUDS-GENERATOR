...
link : inputDistAverageExtOne in-ext-one@cloudGen(8,8)
link : inputDistAverageGenTwo in-gen-two@cloudGen(15,15)
link : inputDistAverageExtTwo in-ext-two@cloudGen(5,15)
link : inputDistAverageGenThree in-gen-three@cloudGen(18,15)
...
portInTransition : in-ext-one@cloudGen(8,8) set-average-ext
portInTransition : in-gen-two@cloudGen(15,15) set-average-gen
portInTransition : in-ext-two@cloudGen(5,15) set-average-ext
portInTransition : in-gen-three@cloudGen(18,15) set-average-gen
portInTransition : in-ext-three@cloudGen(10,15) set-average-ext
